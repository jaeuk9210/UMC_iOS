...
class LoginViewController: UIViewController {
    ...
    private func addViews() {
        [logoImage, emailTextField, passwordTextField, findPasswordLabel, loginButton, leftContour, rightContour, orLable, loginWithFaccbookButton, contour, registerButton].forEach {
            view.addSubview($0)
        }
    }
